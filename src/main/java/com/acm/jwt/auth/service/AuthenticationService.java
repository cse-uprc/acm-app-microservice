...
import com.acm.service.exceptions.InvalidPasswordException;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;

/**
 * Authorization Service takes a user request and checks the values entered for credentials against known values
 * in the database. If correct credentials are passed, it will grant access to the user requested.
 *
